function userOptionsOpen() {
  ...
  function invalidUserName(error) {
    if(error.response.status === 400){
      InvalidfeedBack.innerText = "Iiih parece que esse nao pode... coloca outo mais bonito S2"
  ...
  function delayInvalidEmpty() {
    InvalidfeedBack.innerText = "Eita! sem nome não vai :( Coloca um bem lindo aí S2"
  ...
  function listOnlineUsersRequest() {
    const promisseUsers = axios.get("https://mock-api.driven.com.br/api/v4/uol/messages");
